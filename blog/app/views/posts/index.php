...
<body>
  ...
  <header>
    ...
    <div id="navigation" style="display: flex; font-size: 1.5em;">
      <li><a href="#cate">Nouveautées</a></li>
  ...
  <div style="display: flex; font-size: 1.5em;" id="cate"> 
    <?php foreach($categories as $categorie): ?>
      <li><a href="<?= $categorie->url; ?>"><?= $categorie->titre; ?></a></li>
    <?php endforeach ?>
  </div>

  <div id="posts" style="margin-top: 3%; margin-bottom: -15%;">
     <?php foreach ($posts as $post): ?>
          <div id="post">
            <h1><a href="<?= $post->url ?>"><?= $post->titre; ?></a></h1>
            <p style="font-size:0.9em;"><em><?= $post->categorie; ?></em></p>
            <p><?= $post->extrait; ?></p>
          </div>
      <?php endforeach; ?>
  </div>

  <img src="css/images/coupure_haut.png"/>
  ...
  <div id="contact_background">
    <div id="contact">
      <div id="contact_padding">
        ...
        <h1 style="text-align: center; font-size: 4.1em;">Contactez-moi !</h1>

        <h3><img src=""><em>arthur.simonian@outlook.fr</em></h3>
        <h3><img src=""><em>06 58 84 78 45</em></h3>
